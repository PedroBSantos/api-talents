...
@Entity
public class PerfilEsportistaCustom implements Serializable {
    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id;
    @OneToOne(mappedBy = "perfilEsportistaCustom")
    private EntrevistadorEsporte entrevistadorEsporte;
    ...
    public PerfilEsportistaCustom() {
    }

    public PerfilEsportistaCustom(Integer agilidade, Integer coordenacaoMotora, Integer flexibilidade, Integer forca,
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        PerfilEsportistaCustom other = (PerfilEsportistaCustom) obj;
        if (id == null) {
            if (other.id != null)
                return false;
