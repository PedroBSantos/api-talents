...
public class HandlerException extends ResponseEntityExceptionHandler {
        ...
        public ResponseEntity<ErrorDTO> accessDenied(AccessDeniedException accessDeniedException,
                        HttpServletRequest request) {
                String path = request.getRequestURI();
                ErrorDTO errorDTO = new ErrorDTO(HttpStatus.FORBIDDEN.value(), Instant.now(),
        ...
        @ExceptionHandler({ CreateFileSearchesException.class })
        public ResponseEntity<ErrorDTO> cantCreateFile(CreateFileSearchesException createFileSearchesException,
                        HttpServletRequest request) {
                String path = request.getRequestURI();
                ErrorDTO errorDTO = new ErrorDTO(HttpStatus.BAD_REQUEST.value(), Instant.now(),
                                "Can't create searches file.", createFileSearchesException.getMessage(), path);
